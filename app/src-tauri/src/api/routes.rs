...
pub fn create_router(state: Arc<AppState>) -> Router {
    ...
    let protected_routes = Router::new()
        ...
        .route("/api/sessions/labels", get(handlers::lifecycle::list_session_labels))
        // Recovery
        ...
        // Worktrees
        .route("/api/cronos/worktrees", get(handlers::cronos::list_worktrees))
        ...
        .route("/api/feedback/ideas/dispatch", post(handlers::cronos::dispatch_ideas))
        .route("/api/feedback/ideas/{id}", put(handlers::feedback::update_idea))
        ...
        .route("/api/feedback/reviews", get(handlers::feedback::list_idea_reviews))
        .route("/api/feedback/reviews/{item_id}/accept", post(handlers::feedback::accept_review))
        .route("/api/feedback/reviews/{item_id}/proposal", put(handlers::feedback::update_review_proposal))
        .route("/api/feedback/reviews/{item_id}/gaps", put(handlers::feedback::update_review_gaps))
