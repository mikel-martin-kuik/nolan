...
pub fn create_router(state: Arc<AppState>) -> Router {
    ...
    let protected_routes = Router::new()
        ...
        .route("/api/agents/templates", get(handlers::templates::list_templates))
        ...
        .route("/api/cronos/pipelines", get(handlers::cronos::list_pipelines))
        .route("/api/cronos/pipelines/definitions", get(handlers::cronos::list_pipeline_definitions))
        .route("/api/cronos/pipelines/definitions/default", get(handlers::cronos::get_default_pipeline_definition))
        .route("/api/cronos/pipelines/definitions/{name}", get(handlers::cronos::get_pipeline_definition))
        .route("/api/cronos/pipelines/{id}", get(handlers::cronos::get_pipeline))
        // WebSocket endpoints
        ...
        .route("/api/feedback/hotfixes", get(handlers::feedback::list_hotfixes))
        .route("/api/feedback/hotfixes", post(handlers::feedback::create_hotfix))
        .route("/api/feedback/hotfixes/{id}", put(handlers::feedback::update_hotfix))
        .route("/api/feedback/hotfixes/{id}", delete(handlers::feedback::delete_hotfix))
        .route("/api/feedback/hotfixes/{id}/status", put(handlers::feedback::update_hotfix_status))
