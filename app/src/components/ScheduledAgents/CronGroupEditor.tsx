...
import type { ScheduledAgentGroup, ScheduledAgentInfo } from '@/types';
...
export const CronGroupEditor: React.FC<CronGroupEditorProps> = ({
  ...
  // Edit group state
  const [editingGroup, setEditingGroup] = useState<ScheduledAgentGroup | null>(null);
  ...
  // Open edit form
  const openEditForm = useCallback((group: ScheduledAgentGroup) => {
  ...
  const handleCreateGroup = useCallback(async () => {
    ...
    const group: ScheduledAgentGroup = {
    ...
    try {
      await invoke('create_scheduled_group', { group });
  ...
  const handleUpdateGroup = useCallback(async () => {
    ...
    try {
      await invoke('update_scheduled_group', { group });
  ...
  const handleDeleteGroup = useCallback(async () => {
    ...
    try {
      await invoke('delete_scheduled_group', { group_id: deleteConfirm });
